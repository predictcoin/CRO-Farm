...
export interface CROPredictInterface extends utils.Interface {
  contractName: "CROPredict";
  functions: {
...
export interface CROPredict extends BaseContract {
  contractName: "CROPredict";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CROPredictInterface;
