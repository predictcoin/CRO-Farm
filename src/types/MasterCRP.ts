...
export interface MasterCRPInterface extends utils.Interface {
  contractName: "MasterCRP";
  functions: {
...
export interface MasterCRP extends BaseContract {
  contractName: "MasterCRP";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MasterCRPInterface;
